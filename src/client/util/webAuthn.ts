...
import { AuthenticationExtensionsClientInputsWithPrfBuffer } from '@server/model/webAuthn.js';
...
export async function startAuthenticationWithPRF(optionsJSON: PublicKeyCredentialRequestOptionsJSON) {
    ...
    const prfExtensionResults =
        attestationResponseWebauthn.clientExtensionResults as AuthenticationExtensionsClientInputsWithPrfBuffer;
